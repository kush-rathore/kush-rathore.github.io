  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'kush.rathore@example.com',
      link: 'mailto:kush.rathore@example.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-omniSilver-200 font-orbitron">{info.value}</p>
                    </div>
                  </a>
                ))}
              </div>
            ...
            <div className="card-hologram">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-orbitron font-bold text-omniGreen-400">SOCIAL NETWORKS</h3>
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <a href="#" className="panel-tech text-center group hover:border-omniGreen-500/40 transition-all duration-300">
                  ...
                  <span className="text-omniSilver-200 font-orbitron text-sm">Instagram</span>
                </a>
                <a href="#" className="panel-tech text-center group hover:border-omniGreen-500/40 transition-all duration-300">
                  <div className="w-12 h-12 bg-omniGreen-500/20 rounded-full flex items-center justify-center mx-auto mb-2 text-omniGreen-400 group-hover:bg-omniGreen-500/30 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-omniSilver-200 font-orbitron text-sm">LinkedIn</span>
                </a>
                <a href="#" className="panel-tech text-center group hover:border-omniGreen-500/40 transition-all duration-300">
                  <div className="w-12 h-12 bg-omniGreen-500/20 rounded-full flex items-center justify-center mx-auto mb-2 text-omniGreen-400 group-hover:bg-omniGreen-500/30 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-omniSilver-200 font-orbitron text-sm">GitHub</span>
                </a>
                <a href="#" className="panel-tech text-center group hover:border-omniGreen-500/40 transition-all duration-300">
                  <div className="w-12 h-12 bg-omniGreen-500/20 rounded-full flex items-center justify-center mx-auto mb-2 text-omniGreen-400 group-hover:bg-omniGreen-500/30 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-omniSilver-200 font-orbitron text-sm">Telegram</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="card-hologram">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-orbitron font-bold text-omniGreen-400">TRANSMISSION FORM</h3>
            </div>
