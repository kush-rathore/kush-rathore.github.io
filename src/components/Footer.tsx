        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex justify-center md:justify-end space-x-4">
                <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-omniBlack-800 border border-omniGreen-500/30 rounded-full flex items-center justify-center text-omniGreen-400 hover:bg-omniGreen-500 hover:text-omniBlack-950 transition-all duration-300 hover:scale-110">
                ...
                <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-omniBlack-800 border border-omniGreen-500/30 rounded-full flex items-center justify-center text-omniGreen-400 hover:bg-omniGreen-500 hover:text-omniBlack-950 transition-all duration-300 hover:scale-110">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href={siteConfig.social.github} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-omniBlack-800 border border-omniGreen-500/30 rounded-full flex items-center justify-center text-omniGreen-400 hover:bg-omniGreen-500 hover:text-omniBlack-950 transition-all duration-300 hover:scale-110">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href={siteConfig.social.telegram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-omniBlack-800 border border-omniGreen-500/30 rounded-full flex items-center justify-center text-omniGreen-400 hover:bg-omniGreen-500 hover:text-omniBlack-950 transition-all duration-300 hover:scale-110">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-center md:text-left">
                ...
                <p className="text-omniSilver-400 font-orbitron text-sm mt-1">
                  ...
                  <span className="ml-2">{siteConfig.personal.name.toUpperCase()}</span>
                </p>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-omniSilver-500 font-orbitron text-xs">
              © {currentYear} <span className="text-omniGreen-400 font-bold">{siteConfig.personal.name.toUpperCase()}</span>. 
