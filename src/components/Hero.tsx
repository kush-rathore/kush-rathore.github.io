...
const Hero: React.FC = () => {
  ...
  const texts = siteConfig.hero.roles;
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-omniBlack-950">
            ...
            <div className="card-hologram relative group">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl md:text-5xl font-audiowide font-bold text-omniGreen-400 mb-3 animate-slide-in-left text-center">
                  <span className="text-omniGreen-500 text-glow">{siteConfig.hero.name}</span>
                </h1>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="panel-tech text-center">
                    ...
                    <div className="text-omniSilver-200 font-orbitron">{siteConfig.hero.status}</div>
                  </div>
                  <div className="panel-tech text-center">
                    <div className="text-omniGreen-400 font-orbitron font-bold text-sm mb-1">FOCUS</div>
                    <div className="text-omniSilver-200 font-orbitron">{siteConfig.hero.focus}</div>
                  </div>
                </div>
              </div>
            </div>
